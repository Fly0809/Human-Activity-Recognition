...
def main(argv):
    ...
    data_dir = "/home/RUS_CIP/st191716/dl-lab-24w-team08/Human_Activity_Recognition"
    batch_size = 32
    ...
    if FLAGS.train:
        ...
        checkpoint_path = os.path.join(run_paths['path_ckpts_train'], 'ckpt_final-41')
        #checkpoint_path = f"/home/RUS_CIP/st191716/dl-lab-24w-team08/experiments2/default/ckpts/ckpt_final-41"
